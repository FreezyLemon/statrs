...
mod nist_tests {
    ...
    fn test_covariance_is_symmetric() {
        let data_a = &load_data("nist/lottery.txt")[0..200];
        let data_b = &load_data("nist/lew.txt")[0..200];
