...
mod tests {
    ...
    fn test_entropy() {
        ...
        test_case_special(0.0, 0.1, -0.8836465597893729422377, 1e-15, entropy);
    ...
    fn test_pdf() {
        ...
        test_case_special(10.0, 0.1, 5.530709549844416159162E-49, 1e-64, pdf(8.5));
        test_case_special(10.0, 0.1, 0.5399096651318805195056, 1e-14, pdf(9.8));
        test_case_special(10.0, 0.1, 3.989422804014326779399, 1e-15, pdf(10.0));
        test_case_special(10.0, 0.1, 0.5399096651318805195056, 1e-14, pdf(10.2));
        test_case_special(10.0, 0.1, 5.530709549844416159162E-49, 1e-64, pdf(11.5));
        test_case(-5.0, 1.0, 1.486719514734297707908E-6, pdf(-10.0));
        test_case(-5.0, 1.0, 0.01752830049356853736216, pdf(-7.5));
        test_case_special(-5.0, 1.0, 0.3989422804014326779399, 1e-16, pdf(-5.0));
        ...
        test_case_special(0.0, 10.0, 0.03866681168028492069412, 1e-17, pdf(-2.5));
        test_case_special(0.0, 10.0, 0.03989422804014326779399, 1e-17, pdf(0.0));
        test_case_special(0.0, 10.0, 0.03866681168028492069412, 1e-17, pdf(2.5));
        test_case(0.0, 10.0, 0.03520653267642994777747, pdf(5.0));
        test_case_special(10.0, 100.0, 4.398359598042719404845E-4, 1e-19, pdf(-200.0));
        test_case(10.0, 100.0, 0.002178521770325505313831, pdf(-100.0));
        test_case(10.0, 100.0, 0.003969525474770117655105, pdf(0.0));
        test_case_special(10.0, 100.0, 0.002660852498987548218204, 1e-18, pdf(100.0));
    ...
    fn test_ln_pdf() {
        ...
        test_case_special(10.0, 0.1, (5.530709549844416159162E-49f64).ln(), 1e-13, ln_pdf(8.5));
        test_case_special(10.0, 0.1, (0.5399096651318805195056f64).ln(), 1e-13, ln_pdf(9.8));
        test_case_special(10.0, 0.1, (3.989422804014326779399f64).ln(), 1e-15, ln_pdf(10.0));
        test_case_special(10.0, 0.1, (0.5399096651318805195056f64).ln(), 1e-13, ln_pdf(10.2));
        test_case_special(10.0, 0.1, (5.530709549844416159162E-49f64).ln(), 1e-13, ln_pdf(11.5));
        ...
        test_case_special(-5.0, 1.0, (0.3989422804014326779399f64).ln(), 1e-15, ln_pdf(-5.0));
        ...
        test_case_special(10.0, 100.0, (0.003969525474770117655105f64).ln(),1e-15, ln_pdf(0.0));
        test_case_special(10.0, 100.0, (0.002660852498987548218204f64).ln(), 1e-15, ln_pdf(100.0));
        test_case_special(10.0, 100.0, (6.561581477467659126534E-4f64).ln(), 1e-15, ln_pdf(200.0));
    ...
    fn test_cdf() {
        ...
        test_case_special(5.0, 2.0, 0.0000002866515718, 1e-16, cdf(-5.0));
        test_case_special(5.0, 2.0, 0.0002326290790, 1e-13, cdf(-2.0));
        test_case_special(5.0, 2.0, 0.006209665325, 1e-12, cdf(0.0));
        ...
        test_case_special(5.0, 2.0, 0.993790334674, 1e-12, cdf(10.0));
    }
    ...
    fn test_sf() {
        ...
        test_case_special(5.0, 2.0, 0.9999997133484281, 1e-16, sf(-5.0));
        test_case_special(5.0, 2.0, 0.9997673709209455, 1e-13, sf(-2.0));
        test_case_special(5.0, 2.0, 0.9937903346744879, 1e-12, sf(0.0));
        test_case(5.0, 2.0, 0.6914624612740131, sf(4.0));
        test_case(5.0, 2.0, 0.5, sf(5.0));
        test_case(5.0, 2.0, 0.3085375387259869, sf(6.0));
        test_case_special(5.0, 2.0, 0.006209665325512148, 1e-12, sf(10.0));
    }
    ...
    fn test_inverse_cdf() {
        ...
        test_case_special(5.0, 2.0, -5.0, 1e-14, inverse_cdf(0.00000028665157187919391167375233287464535385442301361187883));
        test_case_special(5.0, 2.0, -2.0, 1e-14, inverse_cdf(0.0002326290790355250363499258867279847735487493358890356));
        test_case_special(5.0, 2.0, -0.0, 1e-14, inverse_cdf(0.0062096653257761351669781045741922211278977469230927036));
        test_case_special(5.0, 2.0, 0.0, 1e-14, inverse_cdf(0.0062096653257761351669781045741922211278977469230927036));
        test_case_special(5.0, 2.0, 4.0, 1e-14, inverse_cdf(0.30853753872598689636229538939166226011639782444542207));
        test_case_special(5.0, 2.0, 5.0, 1e-14, inverse_cdf(0.5));
        test_case_special(5.0, 2.0, 6.0, 1e-14, inverse_cdf(0.69146246127401310363770461060833773988360217555457859));
        test_case_special(5.0, 2.0, 10.0, 1e-14, inverse_cdf(0.9937903346742238648330218954258077788721022530769078));
