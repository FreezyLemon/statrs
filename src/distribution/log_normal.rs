...
mod tests {
    ...
    fn test_mean() {
        ...
        test_case_special(-0.1, 5.5, 3351772.941252693807591, 1e-9, mean);
        test_case(0.1, 0.1, 1.110710610355705232259, mean);
        test_case(0.1, 1.5, 3.40416608279081898632, mean);
        test_case_special(0.1, 2.5, 25.15357415581836182776, 1e-14, mean);
        test_case_special(0.1, 5.5, 4093864.715172665106863, 1e-8, mean);
        test_case_special(1.5, 0.1, 4.50415363028848413209, 1e-15, mean);
        ...
        test_case_special(2.5, 0.1, 12.24355896580102707724, 1e-14, mean);
        test_case_special(2.5, 1.5, 37.52472315960099891407, 1e-11, mean);
        test_case(2.5, 2.5, 277.2722845231339804081, mean);
        test_case(2.5, 5.5, 45127392.83383337999291, mean);
        test_case_special(5.5, 0.1, 245.9184556788219446833, 1e-13, mean);
    ...
    fn test_variance() {
        ...
        test_case_special(-1.0, 0.1, 0.001373811865368952608715, 1e-16, variance);
        test_case(-1.0, 1.5, 10.898468544015731954, variance);
        test_case(-1.0, 2.5, 36245.39726189994988081, variance);
        test_case_special(-1.0, 5.5, 2.5481629178024539E+25, 1e10, variance);
        test_case_special(-0.1, 0.1, 0.008311077467909703803238, 1e-16, variance);
        test_case(-0.1, 1.5, 65.93189259328902509552, variance);
        test_case_special(-0.1, 2.5, 219271.8756420929704707, 1e-10, variance);
        test_case_special(-0.1, 5.5, 1.541548733459471E+26, 1e12, variance);
        test_case_special(0.1, 0.1, 0.01239867063063756838894, 1e-15, variance);
        test_case_special(0.1, 1.5, 98.35882573290010981464, 1e-13, variance);
        test_case_special(0.1, 2.5, 327115.1995809995715014, 1e-10, variance);
        test_case_special(0.1, 5.5, 2.299720473192458E+26, 1e12, variance);
        test_case_special(1.5, 0.1, 0.2038917589520099120699, 1e-14, variance);
        test_case_special(1.5, 1.5, 1617.476145997433210727, 1e-12, variance);
        test_case_special(1.5, 2.5, 5379293.910566451644527, 1e-9, variance);
        test_case_special(1.5, 5.5, 3.7818090853910142E+27, 1e12, variance);
        test_case_special(2.5, 0.1, 1.506567645006046841936, 1e-13, variance);
        test_case_special(2.5, 1.5, 11951.62198145717670088, 1e-11, variance);
        test_case(2.5, 2.5, 39747904.47781154725843, variance);
        test_case_special(2.5, 5.5, 2.7943999487399818E+28, 1e13, variance);
        test_case_special(5.5, 0.1, 607.7927673399807484235, 1e-11, variance);
    ...
    fn test_entropy() {
        ...
        test_case_special(-0.1, 0.1, -0.9836465597893728922776256101467037894202344606927, 1e-15, entropy);
        ...
        test_case_special(0.1, 0.1, -0.7836465597893728811753953638951383851839177797845, 1e-15, entropy);
        test_case_special(0.1, 1.5, 1.9244036413128371293094579749957494785515462375544, 1e-15, entropy);
        ...
        test_case_special(1.5, 0.1, 0.6163534402106271132734895129790789126979238797614, 1e-15, entropy);
        ...
        test_case_special(2.5, 1.5, 4.3244036413128371237583428518699667764333878971003, 1e-15, entropy);
        ...
        test_case_special(5.5, 1.5, 7.3244036413128371237583428518699667764333878971003, 1e-15, entropy);
    ...
    fn test_skewness() {
        ...
        test_case_special(-1.0, 0.1, 0.30175909933883402945387113824982918009810212213629, 1e-14, skewness);
        test_case(-1.0, 1.5, 33.46804679732172529147579024311650645764144530123, skewness);
        test_case_special(-1.0, 2.5, 11824.007933610287521341659465200553739278936344799, 1e-11, skewness);
        test_case_special(-1.0, 5.5, 50829064464591483629.132631635472412625371367420496, 1e4, skewness);
        test_case_special(-0.1, 0.1, 0.30175909933883402945387113824982918009810212213629, 1e-14, skewness);
        test_case(-0.1, 1.5, 33.46804679732172529147579024311650645764144530123, skewness);
        test_case_special(-0.1, 2.5, 11824.007933610287521341659465200553739278936344799, 1e-11, skewness);
        test_case_special(-0.1, 5.5, 50829064464591483629.132631635472412625371367420496, 1e4, skewness);
        test_case_special(0.1, 0.1, 0.30175909933883402945387113824982918009810212213629, 1e-14, skewness);
        test_case(0.1, 1.5, 33.46804679732172529147579024311650645764144530123, skewness);
        test_case_special(0.1, 2.5, 11824.007933610287521341659465200553739278936344799, 1e-11, skewness);
        test_case_special(0.1, 5.5, 50829064464591483629.132631635472412625371367420496, 1e4, skewness);
        test_case_special(1.5, 0.1, 0.30175909933883402945387113824982918009810212213629, 1e-14, skewness);
        test_case(1.5, 1.5, 33.46804679732172529147579024311650645764144530123, skewness);
        test_case_special(1.5, 2.5, 11824.007933610287521341659465200553739278936344799, 1e-11, skewness);
        test_case_special(1.5, 5.5, 50829064464591483629.132631635472412625371367420496, 1e4, skewness);
        test_case_special(2.5, 0.1, 0.30175909933883402945387113824982918009810212213629, 1e-14, skewness);
        test_case(2.5, 1.5, 33.46804679732172529147579024311650645764144530123, skewness);
        test_case_special(2.5, 2.5, 11824.007933610287521341659465200553739278936344799, 1e-11, skewness);
        test_case_special(2.5, 5.5, 50829064464591483629.132631635472412625371367420496, 1e4, skewness);
        test_case_special(5.5, 0.1, 0.30175909933883402945387113824982918009810212213629, 1e-14, skewness);
        test_case(5.5, 1.5, 33.46804679732172529147579024311650645764144530123, skewness);
        test_case_special(5.5, 2.5, 11824.007933610287521341659465200553739278936344799, 1e-11, skewness);
        test_case_special(5.5, 5.5, 50829064464591483629.132631635472412625371367420496, 1e4, skewness);
    }
    ...
    fn test_pdf() {
        ...
        test_case_special(-0.1, 0.1, 1.7968349035073582236359415565799753846986440127816e-104, 1e-118, pdf(0.1));
        test_case_special(-0.1, 0.1, 0.00000018288923328441197822391757965928083462391836798722, 1e-21, pdf(0.5));
        test_case(-0.1, 0.1, 2.3363114904470413709866234247494393485647978367885, pdf(0.8));
        test_case_special(-0.1, 1.5, 0.90492497850024368541682348133921492204585092983646, 1e-15, pdf(0.1));
        test_case_special(-0.1, 1.5, 0.49191985207660942803818797602364034466489243416574, 1e-16, pdf(0.5));
        ...
        test_case_special(-0.1, 2.5, 0.31029619474753883558901295436486123689563749784867, 1e-16, pdf(0.5));
        test_case_special(-0.1, 2.5, 0.19922929916156673799861939824205622734205083805245, 1e-16, pdf(0.8));

// Test removed because it was causing compiler issues (see issue 31407 for rust)
// test_case_special(1.5, 0.1, 4.1070141770545881694056265342787422035256248474059e-313, 1e-322, pdf(0.1));
//

        test_case_special(1.5, 0.1, 2.8602688726477103843476657332784045661507239533567e-104, 1e-116, pdf(0.5));
        test_case(1.5, 0.1, 1.6670425710002183246335601541889400558525870482613e-64, pdf(0.8));
        test_case_special(1.5, 1.5, 0.10698412103361841220076392503406214751353235895732, 1e-16, pdf(0.1));
        test_case_special(1.5, 1.5, 0.18266125308224685664142384493330155315630876975024, 1e-16, pdf(0.5));
        test_case_special(1.5, 1.5, 0.17185785323404088913982425377565512294017306418953, 1e-16, pdf(0.8));
        test_case_special(1.5, 2.5, 0.50186885259059181992025035649158160252576845315332, 1e-15, pdf(0.1));
        test_case_special(1.5, 2.5, 0.21721369314437986034957451699565540205404697589349, 1e-16, pdf(0.5));
        ...
        test_case_special(2.5, 0.1, 3.1225608678589488061206338085285607881363155340377e-221, 1e-233, pdf(0.5));
        test_case_special(2.5, 0.1, 4.6994713794671660918554320071312374073172560048297e-161, 1e-173, pdf(0.8));
        test_case_special(2.5, 1.5, 0.015806486291412916772431170442330946677601577502353, 1e-16, pdf(0.1));
        test_case_special(2.5, 1.5, 0.055184331257528847223852028950484131834529030116388, 1e-16, pdf(0.5));
        test_case(2.5, 1.5, 0.063982134749859504449658286955049840393511776984362, pdf(0.8));
        test_case_special(2.5, 2.5, 0.25212505662402617595900822552548977822542300480086, 1e-15, pdf(0.1));
        test_case_special(2.5, 2.5, 0.14117186955911792460646517002386088579088567275401, 1e-16, pdf(0.5));
        test_case_special(2.5, 2.5, 0.11021452580363707866161369621432656293405065561317, 1e-16, pdf(0.8));
    }
    ...
    fn test_ln_pdf() {
        ...
        test_case_special(-0.1, 0.1, -15.514385149961296196003163062199569075052113039686, 1e-14, ln_pdf(0.5));
        test_case(-0.1, 0.1, 0.84857339958981283964373051826407417105725729082041, ln_pdf(0.8));
        test_case_special(-0.1, 1.5, -0.099903235403144611051953094864849327288457482212211, 1e-15, ln_pdf(0.1));
        test_case_special(-0.1, 1.5, -0.70943947804316122682964396008813828577195771418027, 1e-15, ln_pdf(0.5));
        test_case_special(-0.1, 1.5, -1.1046299420497998262946038709903250420774183529995, 1e-15, ln_pdf(0.8));
        test_case_special(-0.1, 2.5, 0.07924534056485078867266307735371665927517517183681, 1e-16, ln_pdf(0.1));
        ...
        test_case_special(1.5, 0.1, -238.41793403955250272430898754048547661932857086122, 1e-13, ln_pdf(0.5));
        test_case(1.5, 0.1, -146.85439481068371057247137024006716189469284256628, ln_pdf(0.8));
        test_case_special(1.5, 1.5, -2.2350748570877992856465076624973458117562108140674, 1e-15, ln_pdf(0.1));
        test_case_special(1.5, 1.5, -1.7001219175524556705452882616787223585705662860012, 1e-15, ln_pdf(0.5));
        test_case_special(1.5, 1.5, -1.7610875785399045023354101841009649273236721172008, 1e-15, ln_pdf(0.8));
        test_case_special(1.5, 2.5, -0.68941644324162489418137656699398207513321602763104, 1e-15, ln_pdf(0.1));
        ...
        test_case_special(2.5, 0.1, -1149.5549471196476523788026360929146688367845019398, 1e-12, ln_pdf(0.1));
        test_case_special(2.5, 0.1, -507.73265209554698134113704985174959301922196605736, 1e-12, ln_pdf(0.5));
        test_case_special(2.5, 0.1, -369.16874994210463740474549611573497379941224077335, 1e-13, ln_pdf(0.8));
        test_case_special(2.5, 1.5, -4.1473348984184862316495477617980296904955324113457, 1e-15, ln_pdf(0.1));
        test_case_special(2.5, 1.5, -2.8970762200235424747307247601045786110485663457169, 1e-15, ln_pdf(0.5));
        test_case(2.5, 1.5, -2.7491513791239977024488074547907467152956602019989, ln_pdf(0.8));
        test_case_special(2.5, 2.5, -1.3778300581206721947424710027422282714793718026513, 1e-15, ln_pdf(0.1));
    ...
    fn cdf_tests(inverse: bool) {
        ...
        // calls test_case_special after re-arranging the input/output arguments and calling f with input
        let almost = |mean: f64, std_dev: f64, cdf_input: f64, cdf_output: f64, acc: f64| {
            ...
            test_case_special(mean, std_dev, output, acc, f(input));
        };
    ...
    fn test_sf() {
        ...
        test_case_special(-0.1, 0.1, 1.0, 1e-107, sf(0.1));

        // Wolfram Alpha:: SurvivalFunction[ LogNormalDistribution(-0.1, 0.1), 0.8]
        test_case_special(-0.1, 0.1, 0.890919989231123, 1e-14, sf(0.8));

        // Wolfram Alpha:: SurvivalFunction[LogNormalDistribution[1.5, 1], 0.8]
        test_case_special(1.5, 1.0, 0.957568715612642, 1e-14, sf(0.8));

        // Wolfram Alpha:: SurvivalFunction[ LogNormalDistribution(2.5, 1.5), 0.1]
        test_case_special(2.5, 1.5, 0.9993169594777358, 1e-14, sf(0.1));
    }
