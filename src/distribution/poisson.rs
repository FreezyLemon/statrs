...
mod tests {
    ...
    fn test_entropy() {
        ...
        test_case_special(1.5, 1.531959153102376331946, 1e-15, entropy);
        test_case_special(5.4, 2.244941839577643504608, 1e-15, entropy);
    ...
    fn test_skewness() {
        ...
        test_case_special(1.5, 0.8164965809277260327324, 1e-15, skewness);
        test_case_special(5.4, 0.4303314829119352094644, 1e-16, skewness);
        test_case_special(10.8, 0.3042903097250922852539, 1e-16, skewness);
    }
    ...
    fn test_mode() {
        ...
        test_case_exact(1.5, 1, mode);
        test_case_exact(5.4, 5, mode);
        test_case_exact(10.8, 10, mode);
    }
    ...
    fn test_min_max() {
        ...
        test_case_exact(1.5, 0, min);
        test_case_exact(5.4, 0, min);
        test_case_exact(10.8, 0, min);
        test_case_exact(1.5, u64::MAX, max);
        test_case_exact(5.4, u64::MAX, max);
        test_case_exact(10.8, u64::MAX, max);
    }

    #[test]
    fn test_pmf() {
        let pmf = |arg: u64| move |x: Poisson| x.pmf(arg);
        test_case_special(1.5, 0.334695240222645000000000000000, 1e-15, pmf(1));
        test_case_special(1.5, 0.000003545747740570180000000000, 1e-20, pmf(10));
        test_case_special(1.5, 0.000000000000000304971208961018, 1e-30, pmf(20));
        test_case_special(5.4, 0.024389537090108400000000000000, 1e-17, pmf(1));
        test_case_special(5.4, 0.026241240591792300000000000000, 1e-16, pmf(10));
        test_case_special(5.4, 0.000000825202200316548000000000, 1e-20, pmf(20));
        test_case_special(10.8, 0.000220314636840657000000000000, 1e-18, pmf(1));
        test_case_special(10.8, 0.121365183659420000000000000000, 1e-15, pmf(10));
        test_case_special(10.8, 0.003908139778574110000000000000, 1e-16, pmf(20));
    }

    #[test]
    fn test_ln_pmf() {
        let ln_pmf = |arg: u64| move |x: Poisson| x.ln_pmf(arg);
        test_case_special(1.5, -1.09453489189183485135413967177, 1e-15, ln_pmf(1));
        test_case_special(1.5, -12.5497614919938728510400000000, 1e-14, ln_pmf(10));
        test_case_special(1.5, -35.7263142985901000000000000000, 1e-13, ln_pmf(20));
        test_case(5.4, -3.71360104642977159156055355910, ln_pmf(1));
        test_case_special(5.4, -3.64042303737322774736223038530, 1e-15, ln_pmf(10));
        test_case_special(5.4, -14.0076373893489089949388000000, 1e-14, ln_pmf(20));
        test_case_special(10.8, -8.42045386586982559781714423000, 1e-14, ln_pmf(1));
        test_case_special(10.8, -2.10895123177378079525424989992, 1e-14, ln_pmf(10));
        test_case_special(10.8, -5.54469377815000936289610059500, 1e-14, ln_pmf(20));
    }

    #[test]
    fn test_cdf() {
        let cdf = |arg: u64| move |x: Poisson| x.cdf(arg);
        test_case_special(1.5, 0.5578254003710750000000, 1e-15, cdf(1));
        test_case_special(1.5, 0.9999994482467640000000, 1e-15, cdf(10));
        test_case(1.5, 1.0, cdf(20));
        test_case_special(5.4, 0.0289061180327211000000, 1e-16, cdf(1));
        test_case_special(5.4, 0.9774863006897650000000, 1e-15, cdf(10));
        test_case_special(5.4, 0.9999997199928290000000, 1e-15, cdf(20));
        test_case_special(10.8, 0.0002407141402518290000, 1e-16, cdf(1));
        test_case_special(10.8, 0.4839692359955690000000, 1e-15, cdf(10));
        test_case_special(10.8, 0.9961800769608090000000, 1e-15, cdf(20));
    }

    #[test]
    fn test_sf() {
        let sf = |arg: u64| move |x: Poisson| x.sf(arg);
        test_case_special(1.5, 0.44217459962892536, 1e-15, sf(1));
        test_case_special(1.5, 0.0000005517532358246565, 1e-15, sf(10));
        test_case_special(1.5, 2.3372210700347092e-17, 1e-15, sf(20));
        test_case_special(5.4, 0.971093881967279, 1e-16, sf(1));
        test_case_special(5.4, 0.022513699310235582, 1e-15, sf(10));
        test_case_special(5.4, 0.0000002800071708975261, 1e-15, sf(20));
        test_case_special(10.8, 0.9997592858597482, 1e-16, sf(1));
        test_case_special(10.8, 0.5160307640044303, 1e-15, sf(10));
        test_case_special(10.8, 0.003819923039191422, 1e-15, sf(20));
    }
