...
mod tests {
    ...
    fn test_mean() {
        ...
        test_case_special(3.0, 0.3, 7.0, 1e-15 , mean);
    ...
    fn test_variance() {
        ...
        test_case_special(3.0, 0.3, 23.333333333333, 1e-12, variance);
    ...
    fn test_skewness() {
        ...
        test_case_special(0.1, 0.3, 6.425396041, 1e-09, skewness);
    ...
    fn test_min_max() {
        ...
        test_case_exact(1.0, 0.5, 0, min);
        test_case_exact(1.0, 0.3, u64::MAX, max);
    }

    #[test]
    fn test_pmf() {
        let pmf = |arg: u64| move |x: NegativeBinomial| x.pmf(arg);
        test_case_special(4.0, 0.5, 0.0625, 1e-8, pmf(0));
        test_case_special(4.0, 0.5, 0.15625, 1e-8, pmf(3));
        test_case(1.0, 0.0, 0.0, pmf(0));
        test_case(1.0, 0.0, 0.0, pmf(1));
        test_case_special(3.0, 0.2, 0.008, 1e-15, pmf(0));
        test_case_special(3.0, 0.2, 0.0192, 1e-15, pmf(1));
        test_case_special(3.0, 0.2, 0.04096, 1e-15, pmf(3));
        test_case_special(10.0, 0.2, 1.024e-07, 1e-07, pmf(0));
        test_case_special(10.0, 0.2, 8.192e-07, 1e-07, pmf(1));
        test_case_special(10.0, 0.2, 0.001015706852, 1e-07, pmf(10));
        test_case_special(1.0, 0.3, 0.3, 1e-15,  pmf(0));
        test_case_special(1.0, 0.3, 0.21, 1e-15, pmf(1));
        test_case_special(3.0, 0.3, 0.027, 1e-15, pmf(0));
    ...
    fn test_ln_pmf() {
        ...
        test_case_special(3.0, 0.2, -4.828313737, 1e-08, ln_pmf(0));
        test_case_special(3.0, 0.2, -3.952845, 1e-08, ln_pmf(1));
        test_case_special(3.0, 0.2, -3.195159298, 1e-08, ln_pmf(3));
        test_case_special(10.0, 0.2, -16.09437912, 1e-08, ln_pmf(0));
        test_case_special(10.0, 0.2, -14.01493758, 1e-08, ln_pmf(1));
        test_case_special(10.0, 0.2, -6.892170503, 1e-08, ln_pmf(10));
        test_case_special(1.0, 0.3, -1.203972804, 1e-08,  ln_pmf(0));
        test_case_special(1.0, 0.3, -1.560647748, 1e-08, ln_pmf(1));
        test_case_special(3.0, 0.3, -3.611918413, 1e-08, ln_pmf(0));
    ...
    fn test_cdf() {
        ...
        test_case_special(1.0, 0.3, 0.3, 1e-08, cdf(0));
        test_case_special(1.0, 0.3, 0.51, 1e-08, cdf(1));
        test_case_special(1.0, 0.3, 0.83193, 1e-08, cdf(4));
        test_case_special(1.0, 0.3, 0.9802267326, 1e-08, cdf(10));
        test_case(1.0, 1.0, 1.0, cdf(0));
        test_case(1.0, 1.0, 1.0, cdf(1));
        test_case_special(10.0, 0.75, 0.05631351471, 1e-08, cdf(0));
        test_case_special(10.0, 0.75, 0.1970973015, 1e-08, cdf(1));
        test_case_special(10.0, 0.75, 0.9960578583, 1e-08, cdf(10));
    }

    #[test]
    fn test_sf() {
        let sf = |arg: u64| move |x: NegativeBinomial| x.sf(arg);
        test_case_special(1.0, 0.3, 0.7, 1e-08, sf(0));
        test_case_special(1.0, 0.3, 0.49, 1e-08, sf(1));
        test_case_special(1.0, 0.3, 0.1680699999999986, 1e-08, sf(4));
        test_case_special(1.0, 0.3, 0.019773267430000074, 1e-08, sf(10));
        test_case(1.0, 1.0, 0.0, sf(0));
        test_case(1.0, 1.0, 0.0, sf(1));
        test_case_special(10.0, 0.75, 0.9436864852905275, 1e-08, sf(0));
        test_case_special(10.0, 0.75, 0.8029026985168456, 1e-08, sf(1));
        test_case_special(10.0, 0.75, 0.003942141664083465, 1e-08, sf(10));
    }
    ...
    fn test_sf_upper_bound() {
        let sf = |arg: u64| move |x: NegativeBinomial| x.sf(arg);
        test_case_special(3.0, 0.5, 5.282409836586059e-28, 1e-28, sf(100));
    }
}
